...
public class ExtentReportDemo {
    ...
    public void loginTest() throws IOException
    {
        ...
        ExtentHtmlReporter reporter=new ExtentHtmlReporter("/Users/memetiminabliz/Desktop/Memetimin/JavaCoding/src/main/java/Reports/learn_automation1.html");
        ...
        logger2.fail("Failed because of some issues", MediaEntityBuilder.createScreenCaptureFromPath("/Users/memetiminabliz/Desktop/Memetimin/Study/Selenium/TestReports/logo.jpg").build());

        logger2.pass("Failed because of some issues", MediaEntityBuilder.createScreenCaptureFromPath("/Users/memetiminabliz/Desktop/Memetimin/Study/Selenium/TestReports/logo.jpg").build());
